...
export default function SignIn() {
  ...
  return (
    ...
    <div class="flex-1 invisible sm:visible xs:visible">
    <Spline className="absolute m-0 w-1/3 " scene="https://prod.spline.design/ELm-RoZN8MgFalmh/scene.splinecode" />
    </div>
    <div className="flex-container">
            <div className="">
            <img
              className="w-1/3 object-cover mt-10 pt-10 ml-10 sm:w-1/2 xs:w-1/2"
              src="https://eltallerdehector.com/wp-content/uploads/2022/06/7fac6-logo-instagram-transparent.png"
            />
            </div>
    <p className="lg:text-[20px] md:text-[20px] my-20 font-semibold w-1/3 sm:w-1/2 xs:w-1/2 ml-10">
            ...
            <button
              ...
              className="sm:w-1/2 xs:w-1/2 w-1/3 bg-red-400 rounded-lg p-3 text-white hover:bg-red-500 ml-10"
            >
              Login con Google
            </button>
